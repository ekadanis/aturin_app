  ...
  Future<void> _checkFirstTime() async {
    ...
    try {
      ...
      if (!isOnboarded) {
        ...
        // Sudah onboarding dan ada token valid -> ke home
        debugPrint('Splash: Found valid login token, navigating to home');
        context.router.replace(const HomeRoute());
      } else {
        // Sudah onboarding tapi belum login atau token invalid -> ke login
        debugPrint('Splash: No valid token found, navigating to login');
